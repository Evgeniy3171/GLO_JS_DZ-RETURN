...
let money,
   ...
   let budgetStatus = (budgetDay >= 0 && budgetDay < 600) ? console.log('К сожалению у Вас уровень дохода ниже среднего.') : (budgetDay >= 600 && budgetDay < 1200) ? console.log('У Вас средний уровень дохода.') : (budgetDay >= 1200) ? console.log('У Вас высокий уровень дохода.') : console.log('Что-то пошло не так.');
